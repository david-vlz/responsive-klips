...
<p>
  <button class="btn danger" data-toggle="collapse" data-target="#collapseDemoWrap2">
    <h5>Prüfungsleistungen in Medieninformatik <i class="icon-ok-circle"></i>42/90 CPs</h5>
  </button>
</p>
